...
/**
 * CSS do layout minimal
 */
$wa->registerAndUseStyle(
        'mod_hc_socialmedia.minimal',
        'media/mod_hc_socialmedia/css/minimal.css'
);

// ---------------------------------------------------------
// Params globais (mantendo os seus)
// ---------------------------------------------------------
...
<nav class="<?php echo htmlspecialchars($wrapperClass, ENT_QUOTES, 'UTF-8'); ?>"
    ...
    <ul class="mod-hc-socialmedia__list"
        ...
        <?php foreach ($items as $it): ?>
            ...
            // 🔹 Estilo individual (CSS variables)
