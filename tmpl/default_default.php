...
$wa->registerAndUseStyle(
        'mod_hc_socialmedia.default_default',
        'media/mod_hc_socialmedia/css/default.css'
);
...
$shape       = (string) $params->get('shape', 'none');
...
<nav class="<?php echo htmlspecialchars($wrapperClass, ENT_QUOTES, 'UTF-8'); ?>"
    ...
    <ul class="mod-hc-socialmedia__list" role="list" style="gap: <?php echo (int) $gap; ?>px;">
        <?php foreach ($items as $it): ?>
            ...
            $aria   = (string) ($it['aria_label'] ?? ($name !== '' ? $name : 'Social'));
            ...
            // ✅ estilo por item (CSS vars) — pode vir vazio
